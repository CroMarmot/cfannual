<template>
  <div class="problems">
    ...
    <div v-else>
      <div>
        <i18n path="submitMost">
          <template #type>
            {{ tagsDisplay.submit.key }}
          </template>
          <template #count>
            {{ tagsDisplay.submit.value }}
          </template>
        </i18n>
      </div>
      ...
      <div v-else>
        <i18n path="submitACMost">
          <template #type>
            {{ tagsDisplay.ac.key }}
          </template>
          <template #count>
            {{ tagsDisplay.ac.value }}
          </template>
        </i18n>
      </div>
      ...
      <div v-else>
        <i18n path="submitNotACMost">
          <template #type>
            {{ tagsDisplay.notac.key }}
          </template>
          <template #count>
            {{ tagsDisplay.notac.value }}
          </template>
        </i18n>
      </div>
    </div>
