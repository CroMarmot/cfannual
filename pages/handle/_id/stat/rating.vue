    ...
    <div class="rank-part">
      ...
      >
        <i18n path="rating.dropMost">
          ...
          <template #score>
            {{ ratingM[0].newRating - ratingM[0].oldRating }}
          </template>
        </i18n>
      </div>
      <div v-else>
        {{ $t('rating.NeverDropScore') }}
      </div>

      <div
        v-if="ratingM[1].newRating - ratingM[1].oldRating > 0 "
      >
        <i18n path="rating.ObtainMost">
          <template #contest>
          ...
          <template #score>
            {{ ratingM[1].newRating - ratingM[1].oldRating }}
          </template>
        </i18n>
      </div>
      <div v-else>
